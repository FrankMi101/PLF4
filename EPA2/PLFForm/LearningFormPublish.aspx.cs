    ...
    public partial class LearningFormPublish : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                try
                {
                  ...
                  //  btnReturn.Visible = false;
                    ...
                    string signOffResult = SignOff.Signature("Result", userID, WorkingProfile.UserRole, schoolyear, schoolcode, "SO");
        ...
        protected void btnReturn_Click(object sender, EventArgs e)
        {
           ...
           string schoolyear  = Page.Request.QueryString["yID"];
            ...
            string signOffResult = SignOff.Signature(action, userID, WorkingProfile.UserRole, schoolyear, schoolcode, "Publish", vDate);
