<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LearningFormSignOff.aspx.cs" Inherits="PLF.PLFForm.LearningFormSignOff" %>
        ...
        <table style="width: 300px; text-align: center; margin: auto">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnReturn" Text="Return" Width="100px" runat="server" OnClick="btnReturn_Click" />
                </td>
                <td></td>
            </tr>
        </table>
