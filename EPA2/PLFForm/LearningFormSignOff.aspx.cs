    ...
    public partial class LearningFormSignOff : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                string signOffResult = SignOff.Signature("Result", userID, WorkingProfile.UserRole, schoolyear, schoolcode, signType);
        ...
        protected void btnReturn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string signOffResult = SignOff.Signature("SignOff", userID, WorkingProfile.UserRole, schoolyear, schoolcode, signType);
            }
            catch (Exception exp)
            {
                var em = exp.Message;
