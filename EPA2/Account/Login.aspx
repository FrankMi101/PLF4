    ...
    <form id="form1" runat="server">
        ...
        <div class="CenterPostion">
            <h3 style="padding-top: 8%;">
                <asp:Label ID="LabelAppName" runat="server" Text="PLF"></asp:Label>
                &nbsp;&nbsp;
                 Login Page</h3>
            <div class="CenterDIV">
                <table>
                    ...
                    <tr>
                        <td>
                            <img src="../images/SLIP_Logo.png" height="120" width="120" />
                        </td>
                        <td>
                            <table style="width: 300px; text-align: center; margin: auto">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 35%">
                                        <asp:TextBox ID="txtDomain" runat="server" Text="cec" Width="120px" /></td>
