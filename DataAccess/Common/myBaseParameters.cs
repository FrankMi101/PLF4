...
namespace DataAccess
{
    public class myBaseParameters
    {
        ...
        public static   MyADO.MyParameterDB myParaDB  = new MyADO.MyParameterDB();

        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate )
        {
            SetSQLParameter.setParameterArray(myPara, DbType.String, 0, 30, "@Operate", operate);
         }
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID)
        {
            SetupBaseParameters(ref myPara, operate);
            SetSQLParameter.setParameterArray(myPara, DbType.String, 1, 30, "@UserID", userID);
        }
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear, string schoolCode)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear, string schoolCode, string employeeID)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear, string schoolCode, string employeeID, string sessionID)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear, string schoolCode, string employeeID, string sessionID, string category)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear, string schoolCode, string employeeID, string sessionID, string category, string area)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear, string schoolCode, string employeeID, string sessionID, string category, string area, string iCode)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear, string schoolCode, string employeeID, string sessionID, string category, string area, string iCode,string domainID)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear, string schoolCode, string employeeID, string sessionID, string category, string area, string iCode, string domainID,string competencyID)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string schoolYear, string schoolCode, string employeeID, string sessionID, string category, string area, string iCode, string domainID, string competencyID, string lookForsID)
        {
    ...
    public class myBaseParametersB
    {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID )
        {
            SetupBaseParameters(ref myPara, operate, userID);
            SetSQLParameter.setParameterArray(myPara,  DbType.String, 2, 10, "@Category", categoryID); 
        }
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID, string areaID )
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID, string areaID, string itemCode)
        {
        ...
        //public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID, string areaID, string itemCode,  string schoolYear)
        //{
        ...
        //}
        //public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID, string areaID, string itemCode, string schoolYear, string schoolCode)
        //{
        ...
        //}
        //public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID, string areaID, string itemCode, string schoolYear, string schoolCode,string sessionID)
        //{
        ...
        //}
        //public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID, string areaID, string itemCode, string schoolYear, string schoolCode, string sessionID, string employeeID)
        //{
    ...
    public class myBaseParametersC
    {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID, string areaID, string schoolYear)
        {
             SetupBaseParameters(ref myPara, operate, userID, categoryID, areaID);
             SetSQLParameter.setParameterArray(myPara, DbType.String, 4, 8, "@SchoolYear", schoolYear);
        }
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID, string areaID,  string schoolYear, string schoolCode)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string categoryID, string areaID, string schoolYear, string schoolCode,string IDs)
        {
    ...
    public class myBaseParametersL
    {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string Para1)
        {
            SetupBaseParameters(ref myPara, operate, userID);
            SetSQLParameter.setParameterArray(myPara, DbType.String, 2, 30, "@Para1", Para1);
        }
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string Para1, string Para2)
        {
        ...
        public static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string Para1, string Para2, string Para3)
        {
