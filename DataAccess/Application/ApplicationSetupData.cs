...
namespace DataAccess
{
    public class ApplicationSetupData
    {
        ...
        {
            string SP = "dbo.EPA_ORG_SchoolsList";
            MyADO.MyParameterDB[] myPara = new MyADO.MyParameterDB[15];
        ...
        private static void SetupThisParameters(ref MyADO.MyParameterDB[] myPara, string action, string userID, string category, string area, string IDs, string code, string name, string comments, string active)
        {
